...
"C:\Program Files\Autodesk\Maya%TOOL%\bin\maya.exe" -command "python(\"import cache_building\")" -file "С:\\TestResources\\rpr_maya_autotests_assets\\material_baseline.mb"